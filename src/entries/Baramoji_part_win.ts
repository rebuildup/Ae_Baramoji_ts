...
import '../init';
import { makeProgressHelpers, promptDuplicateMode, runDecomposeTextToShapeParts } from '../core';
...
(function BaramojiPartWinEntry(this: unknown): void {
  ...
  try {
    runDecomposeTextToShapeParts({ onProgress: progress.update, duplicateMode: mode });
  } finally {
    progress.close();
  }
})();
